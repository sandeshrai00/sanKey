...
Panel.qml = SoraWidget.qml (done)
Service.qml = SoraService.qml (done)
Model.js = SoraKeyStore.js (done)
SoraDropdown.qml = same
SoraTextField.qml = same
SearchablePackDropdown.qml = SoraPackPicker.qml (done)
CLEANUP.md = same
scripts/sorakey-setup = sora-install (done)
scripts/build-sorakey.sh = sora-build.sh (done)
scripts/sorakey-enable-capture.sh = sora-keyboard-access.sh (done)
scripts/sorakey-detached-run =  sorakey-detached (done)
scripts/sorakey-import-pack.py = sora-pack-import.py (done)
scripts/sorakey-export-logs.py = sora-export-logs.py (done)
scripts/_v1_shared.py = same
scripts/uninstall.sh = sora-uninstall.sh (done)
assets/icon-bar-dark.svg = same
assets/icon-bar-light.svg = same
assets/icon-hero-dark.svg = same
assets/icon-hero-light.svg = same
udev/70-sorakey-keyboard.rules = 70-sora-keyboard.rules (done)
